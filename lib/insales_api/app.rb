module InsalesApi
  class App
    ...
    def auth_token(salt = self.salt, user_email = '', user_name = '', user_id = '', email_confirmed = '')
      @auth_token ||= InsalesApi::Password.create(password, salt, user_email, user_name, user_id, email_confirmed)
    end
